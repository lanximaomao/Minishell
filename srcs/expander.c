...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/10 17:21:46 by lliu              #+#    #+#             */
/*   Updated: 2023/07/31 16:54:20 by lsun             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	while ((quote_type == 1 && tmp_line[++(*i)] != '\'') || (quote_type == 2
			&& tmp_line[++(*i)] != '\"') || (quote_type == 0 && tmp_line[++(*i)]
...
static char	**exp_each_part(int quote_type, t_input *input, t_list *env_lst,
		int *i)
{
	int		len;
	int		start;
